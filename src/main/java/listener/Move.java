...
public class Move implements Listener {
    ...
    public void onMove(PlayerMoveEvent e){
        ...
        if(player.hasPermission("simpleteleporter.up")&&player.getLocation().subtract(0, 1, 0).getLevelBlock().getId()== Block.DAYLIGHT_DETECTOR&&player.getLocation().add(0, 0, 0).getLevelBlock().getId()== Block.AIR){
            int i = 4;
